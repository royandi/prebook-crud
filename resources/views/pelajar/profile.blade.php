							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$pelajar->getAvatar()}}" class="img-circle" alt="Avatar" style="width:95px;height:100px;">
										<h3 class="name">{{$pelajar->nama_depan}}</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>Jenis Kelamin <span>{{$pelajar->jenis_kelamin}}</span></li>
											<li>Pendidikan <span>{{$pelajar->pendidikan}}</span></li>
											<li>Alamat <span>{{$pelajar->alamat}}</span></li>
										</ul>
									</div>
									<div class="profile-info">
									...
									<div class="text-center"><a href="/pelajar/{{$pelajar->id}}/edit" class="btn btn-warning">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
							<!-- END LEFT COLUMN -->
